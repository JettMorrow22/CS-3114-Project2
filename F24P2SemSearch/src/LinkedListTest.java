...
public class LinkedListTest extends TestCase {
    ...
    public void setUp() {
        ...
        one = new Seminar(1, "title", "data", 1, (short)1, (short)1, 1, keywords, "description");
        two = new Seminar(2, "title", "data", 2, (short)2, (short)2, 2, keywords, "description");
        three = new Seminar(3, "title", "data", 3, (short)3, (short)3, 3, keywords, "description");
        four = new Seminar(4, "title", "data", 4, (short)4, (short)4, 4, keywords, "description");
        five = new Seminar(5, "title", "data", 5, (short)5, (short)5, 5, keywords, "description");
